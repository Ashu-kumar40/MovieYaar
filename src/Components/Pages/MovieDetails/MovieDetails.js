    ...
    <>
      <div className={styles.parentContainer}>
        <div className={styles.details}>
          <img className={styles.poster} src={`https://image.tmdb.org/t/p/original/${movie && movie.poster_path}`} alt="" />
          <div className="posterDetails">
              <img className={styles.movieBanner} src={`https://image.tmdb.org/t/p/original/${movie && movie.backdrop_path}`} alt="" />
